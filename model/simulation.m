...
if tune_parameters
    old_params = load("controllers/controller_constants.mat").Parameters;
    old_params
    best_params = fminsearch(@function_handler, old_params); 

    disp("Found Best Parameters:")
    best_params

    save("controllers/controller_constants.mat", "best_params");
